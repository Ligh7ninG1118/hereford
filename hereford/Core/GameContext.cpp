...
void GameContext::LoadData()
{
	...
	testEventSub = GameEvent::Subscribe<EventTestA>(std::bind(&GameContext::EventListner, this, std::placeholders::_1));

}


void GameContext::EventListner(EventTestA inEvent)
{
